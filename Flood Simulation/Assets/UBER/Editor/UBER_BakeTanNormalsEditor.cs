...
//	}
	...
	private static void Process(MeshFilter mf, UBERTexBakeType type, ref string save_path) {
		...
		TextureImporterFormat importer_format;
		if (type==UBERTexBakeType.Tangents) {
			format=TextureFormat.ARGB32;
			importer_format=TextureImporterFormat.ARGB32;
		} else {
			format=TextureFormat.ARGB32;
			importer_format=TextureImporterFormat.ARGB32;
			// (store scaleUV in textures A channel)
//			format=TextureFormat.RGB24;
//			importer_format=TextureImporterFormat.RGB24;
		}
		...
		if (_importer) {
			...
			tex_importer.textureFormat=importer_format;
		}
