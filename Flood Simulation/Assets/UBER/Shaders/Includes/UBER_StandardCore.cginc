...
#endif
#if UNITY_SPECCUBE_BOX_PROJECTION || UNITY_LIGHT_PROBE_PROXY_VOLUME || defined(POM) || defined(_TRANSLUCENCY) || defined(_GLITTER) || defined(_SNOW) || defined(DISTANCE_MAP) || defined(EXTRUSION_MAP) || defined(_WETNESS)
