	...
	UnityLight light, UnityIndirect gi)
{
	...
	half D = NDFBlinnPhongNormalizedTerm (nh, RoughnessToSpecPower (roughness*_MAX_SMOOTHNTESS_SPEC + (1.0 - _MAX_SMOOTHNTESS_SPEC)));
#endif
	...
	//specularTerm *= pow(saturate(1.0f + dot(normal, viewDir)), 4.0);
